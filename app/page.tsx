...
export default function Home() {
  return (
    <main className="min-h-screen flex flex-col items-center justify-center relative overflow-hidden"
      style={{ background: "linear-gradient(160deg, #dce8f5 0%, #c8ddf0 40%, #bdd4ec 100%)" }}>
      
      {/* Soft background blobs */}
      <div style={{ position: "absolute", width: 300, height: 300, borderRadius: "50%", background: "#a189a8", opacity: 0.35, top: -80, right: -60, filter: "blur(40px)" }} />
      <div style={{ position: "absolute", width: 250, height: 250, borderRadius: "50%", background: "#a189a8", opacity: 0.4, bottom: -60, left: -40, filter: "blur(40px)" }} />
      ...
      <h1 className="text-4xl font-bold text-center" style={{ color: "#2a3f5c", fontFamily: "serif" }}>
        Grow Your Producitivity
      </h1>
      <p className="text-sm tracking-widest uppercase" style={{ color: "#7a9abf" }}>
        An applicaation made by Tarana, Micah, Emily, Evy
      </p>
